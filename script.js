...
const elements = {
    get signInButton() => document.getElementById('signInButton');
    get signOutButton() => document.getElementById('signOutButton');
    get outputDiv() =>  document.getElementById('outputDiv');
};
...
const state = {
    ...
    set signedIn(v) {
        elements.signInButton().disabled = !!v;
        elements.signOututton().disabled = !!!v;
    }
}
